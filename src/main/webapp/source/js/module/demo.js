...
(function (root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        define(['jquery', 'Demo'], function($, me) {
            root.Demo = factory(root, me, $);
        });
    } else {
        root.Demo = factory(root, {}, (root.jQuery || root.Zepto || root.ender || root.$));
    }
})(this, function (root, me, $) {
    // Returns a reference to this, Resolve naming conflicts
    var previousTanMv = root.Demo;
    me.noConflict = function() {
        root.Demo = previousTanMv;
        return this;
    };
